...
var vehicle = (function() {
  ...
  function addRow(rowId) {
    ...
    var zPos = rowId * globals.blockDepth;
    vehicles[rowId] = [];
    var maxX = globals.maxX - (width * globals.blockWidth);
    for (var i = globals.minX;
         i < maxX;
         i += (support.getRand(3, 5) * width * globals.blockWidth)) {
  ...
  function updateRow(rowId, delta) {
    ...
    for (var i = 0; i < vehicles[rowId].length; ++i) {
      ...
      vehicle.position.x -= (movement * delta * vehicle.data.speed);
